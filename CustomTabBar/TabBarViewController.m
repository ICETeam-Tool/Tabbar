...
- (void)viewDidLoad {
    ...
    //自定义赋值
    self.custTarBar = [[CustomTarBar alloc]initWithMarkCount:4 markImageArray:iamgeArray placeholderImageArray:nil markTitleArray: nil];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [self.custTarBar concorRadiusWithIndexArray:@[@"3"]];
